    ...
    internal static class HelpContent
    {
        ...
        private static string GetAboutZh()
        {
            return "<h1>OneNote 脑图 — 使用帮助</h1>"
                ...
                + "<tr><td><code>方向键</code></td><td>在节点之间导航</td></tr>"
                + "<tr><td><code>Alt+↑ / Alt+↓</code></td><td>在同级节点中上移 / 下移所选节点</td></tr>"
                + "<tr><td><code>F4</code></td><td>编辑节点属性</td></tr>"
                + "<tr><td><code>Ctrl+Z / Ctrl+Y</code></td><td>撤销 / 重做</td></tr>"
                + "<tr><td><code>Ctrl+C / Ctrl+V</code></td><td>复制 / 粘贴节点分支</td></tr>"
                + "<tr><td><code>Ctrl+F</code></td><td>查找节点</td></tr>"
                + "<tr><td><code>Ctrl+S</code></td><td>保存脑图</td></tr>"
                + "</table>"
                + "<p><b>鼠标操作：</b>Ctrl+单击多选 · 双击节点编辑 · Ctrl+滚轮缩放 · 滚轮滚动画布 · 拖拽空白区平移</p>"
                + "<h2>编辑器特性</h2>"
                + "<ul>"
                + "<li><b>三种布局</b>：右树 / 对称 / 组织架构</li>"
                + "<li><b>五种主题</b>：默认 / 紫色 / 简约 / 清新 / 暖色</li>"
                + "<li><b>三种节点形状</b>：圆角 / 矩形 / 胶囊</li>"
                + "<li><b>两种节点尺寸</b>：固定尺寸 / 适应内容</li>"
        ...
        private static string GetEditZh()
        {
            return "<h1>编辑与保存</h1>"
                ...
                + "<li>切换节点尺寸：固定尺寸保持紧凑，适应内容自动换行显示全文</li>"
                + "<li>编辑节点备注、链接、颜色和图标</li>"
                + "<li>搜索节点，复制 / 粘贴完整分支</li>"
                + "<li>Ctrl+单击多选，批量设置颜色和图标</li>"
                + "<li>使用 Alt+↑ / Alt+↓ 调整同级节点顺序</li>"
                + "<li>Ctrl+鼠标滚轮缩放，拖拽平移画布</li>"
                + "</ul>"
                + "<h2>保存</h2>"
        ...
        private static string GetAboutEn()
        {
            return "<h1>OneNote Mind Map — Help</h1>"
                + "<p class='version'>Version: 1.5.2</p>"
                ...
                + "<tr><td><code>Arrow keys</code></td><td>Navigate between nodes</td></tr>"
                + "<tr><td><code>Alt+Up / Alt+Down</code></td><td>Move selected nodes among their siblings</td></tr>"
                + "<tr><td><code>F4</code></td><td>Edit node properties</td></tr>"
                + "<tr><td><code>Ctrl+Z / Ctrl+Y</code></td><td>Undo / Redo</td></tr>"
                + "<tr><td><code>Ctrl+C / Ctrl+V</code></td><td>Copy / Paste a node branch</td></tr>"
                + "<tr><td><code>Ctrl+F</code></td><td>Find nodes</td></tr>"
                + "<tr><td><code>Ctrl+S</code></td><td>Save mind map</td></tr>"
                + "</table>"
                + "<p><b>Mouse:</b> Ctrl+click to multi-select · Double-click to edit · Ctrl+scroll to zoom · Scroll the canvas · Drag to pan</p>"
                ...
                + "<li><b>Two node sizing modes</b>: Fixed / Fit Content</li>"
                ...
                + "<li>Marquee selection and dragging multiple nodes as a group are not yet supported</li>"
                + "</ul>"
        ...
        private static string GetEditEn()
        {
            return "<h1>Edit & Save</h1>"
                ...
                + "<li>Node sizing: Fixed for compact maps, or Fit Content for wrapped full text</li>"
                + "<li>Edit node notes, links, colors, and icons</li>"
                + "<li>Search nodes and copy/paste complete branches</li>"
                + "<li>Ctrl+click to multi-select and batch-apply colors and icons</li>"
                + "<li>Use Alt+Up / Alt+Down to reorder siblings</li>"
                + "<li>Ctrl+mouse wheel to zoom, drag to pan</li>"
                + "</ul>"
                + "<h2>Saving</h2>"
        ...
        private static string GetShortcutsEn()
        {
            return "<h1>Editor Shortcuts</h1>"
                ...
                + "<li>Ctrl + click — Add or remove nodes from the selection</li>"
                + "<li>Ctrl + scroll wheel — Zoom canvas</li>"
                + "<li>Scroll wheel — Scroll canvas</li>"
