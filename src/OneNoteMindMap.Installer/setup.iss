...
Root: {#ComRoot}; Subkey: "CLSID\{#MyGuid}\InprocServer32"; ValueType: string; ValueName: "Assembly"; ValueData: "OneNoteMindMap.AddIn, Version=1.5.0.0, Culture=neutral, PublicKeyToken=null"
...
Root: {#ComRoot}; Subkey: "CLSID\{#MyGuid}\InprocServer32\1.5.0.0"; ValueType: string; ValueName: "Class"; ValueData: "OneNoteMindMap.AddIn.Connect"
Root: {#ComRoot}; Subkey: "CLSID\{#MyGuid}\InprocServer32\1.5.0.0"; ValueType: string; ValueName: "Assembly"; ValueData: "OneNoteMindMap.AddIn, Version=1.5.0.0, Culture=neutral, PublicKeyToken=null"
Root: {#ComRoot}; Subkey: "CLSID\{#MyGuid}\InprocServer32\1.5.0.0"; ValueType: string; ValueName: "RuntimeVersion"; ValueData: "v4.0.30319"
Root: {#ComRoot}; Subkey: "CLSID\{#MyGuid}\InprocServer32\1.5.0.0"; ValueType: string; ValueName: "CodeBase"; ValueData: "{app}\OneNoteMindMap.AddIn.dll"
